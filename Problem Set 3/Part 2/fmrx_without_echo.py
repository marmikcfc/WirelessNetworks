...
# Title: Fmrx Without Echo
# Generated: Sun Mar  6 20:34:38 2016
##################################################
...
class fmrx_without_echo(grc_wxgui.top_block_gui):
...
def main(top_block_cls=fmrx_without_echo, options=None):
