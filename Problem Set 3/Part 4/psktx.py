...
# Title: Psktx
# Generated: Sat Mar  5 08:25:51 2016
##################################################
...
class psktx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0 = osmosdr.sink( args="numchan=" + str(1) + " " + "hackrf=0x000000000x000000000x457863c80x320c831f" )
        ...
        self.digital_diff_encoder_bb_0 = digital.diff_encoder_bb(my_constellation.arity())
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc((my_constellation.points()), my_constellation.dimensionality())
        self.blocks_packed_to_unpacked_xx_0 = blocks.packed_to_unpacked_bb(my_constellation.bits_per_symbol(), gr.GR_MSB_FIRST)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((0.05, ))
        self.blks2_packet_encoder_0 = grc_blks2.packet_mod_b(grc_blks2.packet_encoder(
        		samples_per_symbol=2,
        		bits_per_symbol=my_constellation.bits_per_symbol(),
        		preamble="",
        		access_code="",
        		pad_for_usrp=False,
        	),
